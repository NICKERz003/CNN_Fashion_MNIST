...
Features
- Predict Fashion MNIST images from random test samples.
- Predict images uploaded by users.
- Display prediction confidence as a bar chart.
- Show accuracy/loss, confusion matrix, and classification report after training.
- Examples of training code for each model included.
...
- VGG16 – Transfer learning, input resized to 32x32, 3 channels.
- MobileNetV2 – Transfer learning, input resized to 32x32, 3 channels (train with 96x96).
>>>>>>> 1d027f41019f1af0412136756d3e351ae54e9b61
